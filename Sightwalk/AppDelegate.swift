...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let googleMapsApiKey = GoogleConstants.key
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if !isFirstRun {
            ...
            let initialViewController = storyboard.instantiateViewControllerWithIdentifier("mainPage")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "net.sightwalk.Sightwalk" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Sightwalk", withExtension: "momd")!
    ...
    private(set) var tmpContext : NSManagedObjectContext = NSManagedObjectContext(concurrencyType: .PrivateQueueConcurrencyType)
